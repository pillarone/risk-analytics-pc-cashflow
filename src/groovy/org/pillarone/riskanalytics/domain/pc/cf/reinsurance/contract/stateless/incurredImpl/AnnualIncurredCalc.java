...
public class AnnualIncurredCalc implements IIncurredCalculation {
    ...
    public LossAfterTermStructure cededIncurredRespectTerm(IAllContractClaimCache claimStore, ILayersInPeriod scaledLayerParameters, PeriodScope periodScope, double termExcess, double termLimit, ContractCoverBase coverageBase, IPremiumPerPeriod premiumPerPeriod) {
