...
import org.pillarone.riskanalytics.domain.pc.cf.reinsurance.contract.proportional.commission.SlidingCommission;
 ...
 */
public class SlidingCommissionStrategy extends AbstractCommissionStrategy {
    ...
    public ICommission getCalculator() {
        TreeMap<Double, Double> commissionRatePerLossRatio;
        ...
        return new SlidingCommission(commissionRatePerLossRatio, useClaims);
    }
}
