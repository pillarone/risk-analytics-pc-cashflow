...
public class AADQuotaShareContract extends QuotaShareContract {
    ...
    public AADQuotaShareContract(double quotaShare, ICommission commission, AadLimitStrategy limit, ProportionalPremiumBase premiumBase) {
    ...
    public ClaimCashflowPacket calculateClaimCeded(ClaimCashflowPacket grossClaim, ClaimStorage storage, IPeriodCounter periodCounter) {
        ...
        double quotaShareReported = adjustedQuote(grossClaim.getReportedIncrementalIndexed(), annualAggregateDeductibleReported);
        double quotaSharePaid = adjustedQuote(grossClaim.getPaidIncrementalIndexed(), annualAggregateDeductiblePaid);
