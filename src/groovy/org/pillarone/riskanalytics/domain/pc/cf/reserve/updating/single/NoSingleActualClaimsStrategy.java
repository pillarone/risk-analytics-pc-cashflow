...
public class NoSingleActualClaimsStrategy extends AbstractParameterObject implements ISingleActualClaimsStrategy {
    ...
    public SingleHistoricClaim historicClaims(int period, IPeriodCounter periodCounter, DateTime updateDate, PayoutPatternBase payoutPatternBase) {
        return null;
    }

    public void checkClaimRootOccurenceAgainstFirstActualPaid(List<ClaimRoot> baseClaims, int contractPeriod,
