 ...
 */
public class GrossLegalEntitiesCoverAttributeStrategy extends AbstractParameterObject implements ICoverAttributeStrategy {

    private ComboBoxTableMultiDimensionalParameter legalEntities;

    public IParameterObjectClassifier getType() {
        return CoverAttributeStrategyType.GROSSLEGALENTITIES;
    }
