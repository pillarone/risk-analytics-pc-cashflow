 ...
 */
class ReinsuranceContractIndices extends DynamicComposedComponent {
    ...
    Component createDefaultSubComponent() {
        ReinsuranceContractIndex index = new ReinsuranceContractIndex(parmIndex : IndexStrategyType.getDefault());
        return index
    }
