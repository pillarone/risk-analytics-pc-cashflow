...
public class ResourceExternalValuesByIterationAndDateStrategy extends AbstractExternalValuesByIterationAndDateStrategy {
    ...
    private ResourceHolder<ExternalValuesExtendedResource> referencedIterationDateData = new ResourceHolder<ExternalValuesExtendedResource>(ExternalValuesExtendedResource.class);
