 ...
 */
public class SurplusIndexedBoundaryIndexStrategy extends AbstractParameterObject implements IBoundaryIndexStrategy  {
    ...
    private SurplusBoundaryIndexApplication indexedValues;

    @Override
    public IParameterObjectClassifier getType() {
        return SurplusBoundaryIndexType.INDEXED;
    }
