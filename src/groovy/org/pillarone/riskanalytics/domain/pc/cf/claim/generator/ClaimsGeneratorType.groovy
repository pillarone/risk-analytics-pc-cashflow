...
//            produceClaim: FrequencySeverityClaimType.AGGREGATED_EVENT])
    ...
    public static final all = [ATTRITIONAL, FREQUENCY_SEVERITY] //, ATTRITIONAL_WITH_DATE, FREQUENCY_AVERAGE_ATTRITIONAL, OCCURRENCE_AND_SEVERITY, SEVERITY_OF_EVENT_GENERATOR, PML]
