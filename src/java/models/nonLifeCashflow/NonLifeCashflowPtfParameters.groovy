...
components {
	claimsGenerators {
		subMotorAttritional {
			...
			parmUnderwritingSegments[0]=new org.pillarone.riskanalytics.core.parameterization.ComboBoxTableMultiDimensionalParameter(org.pillarone.riskanalytics.core.util.GroovyUtils.toList([["motor"]]),["Underwriting Information"], org.pillarone.riskanalytics.domain.pc.cf.exposure.IUnderwritingInfoMarker)
		}
		subMotorSingle {
