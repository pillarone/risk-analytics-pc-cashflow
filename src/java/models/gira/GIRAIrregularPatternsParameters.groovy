...
applicationVersion='1.4-ALPHA-2'
...
components {
	claimsGenerators {
		subMarineContinuous {
			...
			parmReportingPattern[0]=new org.pillarone.riskanalytics.core.parameterization.ConstrainedString(org.pillarone.riskanalytics.domain.pc.cf.pattern.IReportingPatternMarker, 'sub4y')
