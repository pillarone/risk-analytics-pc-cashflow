...
periodCount=1
displayName='PMO233 Test 2 - SL Rel Param'
...
comments=["""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1360071763013),user:null, comment: \"\"\"v3: cover ceded only from A\"\"\", tags:(['version'] as Set)]""","""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1360071763012),user:null, comment: \"\"\"v4: absolute premium for stoploss\"\"\", tags:(['version'] as Set)]""","""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1360071763004),user:null, comment: \"\"\"v4: absolute premium for stoploss\"\"\", tags:(['version'] as Set)]""","""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1360071764488),user:null, comment: \"\"\"v2: use segments instead of LE in matrix\"\"\", tags:(['version'] as Set)]"""]
tags=[]
