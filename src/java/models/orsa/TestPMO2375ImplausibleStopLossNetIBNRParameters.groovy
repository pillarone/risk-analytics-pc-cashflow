...
components {
	...
	reinsuranceContracts {
		subStopLoss {
			...
			parmCoveredPeriod[0]=org.pillarone.riskanalytics.domain.pc.cf.reinsurance.cover.period.PeriodStrategyType.getStrategy(org.pillarone.riskanalytics.domain.pc.cf.reinsurance.cover.period.PeriodStrategyType.ANNUAL, ["numberOfYears":6,"startCover":new org.joda.time.DateTime(2010, 1, 1, 0, 0, 0, 0),])
