...
comments=["""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1358947141943),user:null, comment: \"\"\"v4: absolute premium for stoploss\"\"\", tags:(['version'] as Set)]""","""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1358947139545),user:null, comment: \"\"\"v3: cover ceded only from A\"\"\", tags:(['version'] as Set)]""","""[path:'ORSA', period:-1, lastChange:new org.joda.time.DateTime(1358947141943),user:null, comment: \"\"\"v4: absolute premium for stoploss\"\"\", tags:(['version'] as Set)]"""]
tags=[]
