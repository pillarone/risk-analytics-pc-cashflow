...
class StructureTests extends GroovyTestCase {
    ...
    ClaimCashflowPacket claimMotor100 = new ClaimCashflowPacket(baseClaimMotor100, 100, 100, 100, 100, 100, 0, 0, 0, null, date20110101, 0)
    ClaimRoot baseClaimMotorHull500 = new ClaimRoot(500d, ClaimType.SINGLE, null, null)
    ClaimCashflowPacket claimMotorHull500 = new ClaimCashflowPacket(baseClaimMotorHull500, 500, 500, 500, 500, 500, 0, 0, 0, null, date20110101, 0)
    ClaimRoot baseClaimAccident = new ClaimRoot(80d, ClaimType.EVENT, null, null)
    ClaimCashflowPacket claimAccident80 = new ClaimCashflowPacket(baseClaimAccident, 80, 80, 80, 80, 80, 0, 0, 0, null, date20110101, 0)
