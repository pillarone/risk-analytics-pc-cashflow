 ...
 */
class TermSpreadsheetContractTests extends SpreadsheetUnitTest {

    static final double EPSILON = 1E-8

    static DateTime beginOfCover = new DateTime(2012,1,1,0,0,0,0)

    static TermReinsuranceContract getArtLayerContract(Double termExcess, Double termLimit, List<Integer> periods,
    ...
    static TermReinsuranceContract getLayerContract(Double termExcess, Double termLimit, List<Integer> periods,
                                                List<Integer> layers, List<Double> shares,
                                                List<Double> periodExcess, List<Double> periodLimit,
                                                List<Double> claimExcess, List<Double> claimLimit, DateTime beginOfCover) {
        IterationScope iterationScope = TestIterationScopeUtilities.getIterationScope(beginOfCover, 3)
    ...
    static TermReinsuranceContract getARTLayerContract(Double termExcess, Double termLimit, TermContractTestUtils.TestLayers layers, DateTime beginOfCover) {
    ...
    static TermReinsuranceContract getLayerContract(Double termExcess, Double termLimit, TermContractTestUtils.TestLayers layers, DateTime beginOfCover) {
...
//    Commented out until we know whether claims are +ve or -ve
   ...
   /*     List<String> sheets = [
        ...
        for (String sheet : sheets) {
            ...
            TermReinsuranceContract contract = getARTLayerContract(
