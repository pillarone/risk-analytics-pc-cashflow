...
class ProfitCommissionStrategyTests extends GroovyTestCase {
    ...
    void testUsage() {
        ...
        commissionStrategy.getCalculator(new DoubleValuePerPeriod()).calculateCommission(claims, underwritingInfo, false, 0)
    ...
    void testApportioning() {
        ...
        commissionStrategy.getCalculator(new DoubleValuePerPeriod()).calculateCommission(claims, underwritingInfo, true, 0) // test that prior commission is added
    ...
    void testProfitCommissionWithPriorFixedCommission() {
        ...
        commissionStrategy.getCalculator(new DoubleValuePerPeriod()).calculateCommission(claims, underwritingInfo, true, 0)
