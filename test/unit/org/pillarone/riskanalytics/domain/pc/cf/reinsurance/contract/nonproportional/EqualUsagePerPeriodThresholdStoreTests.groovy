...
class EqualUsagePerPeriodThresholdStoreTests extends GroovyTestCase {
    ...
    void testUsage() {
        ...
        assertEquals 'P0 correct init of ultimate', 1000, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 0)
        ...
        thresholdStore.plus(-300, BasedOnClaimProperty.ULTIMATE_UNINDEXED, 0)
        assertEquals 'P0 correct update of ultimate', 700, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 0)
        ...
        assertEquals 'P1 correct reduction for ultimate P0', 0, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 0)
        ...
        assertEquals 'P1 correct init of ultimate P1', 700, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 1)
        ...
        thresholdStore.plus(-300, BasedOnClaimProperty.ULTIMATE_UNINDEXED, 1)
        assertEquals 'P1 correct update of ultimate', 400, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 1)
        ...
        assertEquals 'P2 correct reduction for ultimate P0', 0, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 0)
        ...
        assertEquals 'P2 correct reduction for ultimate P1', 0, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 1)
        ...
        assertEquals 'P2 correct init of ultimate P2', 400, thresholdStore.get(BasedOnClaimProperty.ULTIMATE_UNINDEXED, 2)
