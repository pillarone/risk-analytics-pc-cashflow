...
class MatrixReinsuranceContractsTests extends GroovyTestCase {
    ...
    private Map setupParameters(List parameters = [[''], [''], [''], [''], [''], ['ANY']], List benefitContracts = []) {
        ...
        result.flexibleCover.comboBoxValues[1] = ['': null, 'contract1': firstTreaty, 'contract2': secondTreaty]
...
// PMO-2233 / Test1
    ...
    private ReinsuranceContract createTestContract(String contractName, List matrixParams, Double qoutaShare = 0.2d, List benefitContracts = []) {
        ...
        contract.parmCover = CoverAttributeStrategyType.getStrategy(CoverAttributeStrategyType.MATRIX, setupParameters(matrixParams, benefitContracts))
        return contract
    }
