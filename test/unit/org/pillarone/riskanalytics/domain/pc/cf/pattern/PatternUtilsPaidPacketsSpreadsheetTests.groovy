 ...
 */
class PatternUtilsPaidPacketsSpreadsheetTests extends SpreadsheetUnitTest {

    static Log LOG = LogFactory.getLog(PatternUtilsPaidPacketsSpreadsheetTests.class);
    static final private double EPSILON = 1E-7

    @Override
    List<String> getSpreadsheetNames() {
        [
         'paidPacketsDevelopment/ART-687-1-CODNoInPeriodStartPeriod.xlsx',
         'paidPacketsDevelopment/ART-687-2-CODYesInPeriodMiddleActualClaims.xlsx',
         'paidPacketsDevelopment/ART-687-3-CODYesLongTimeIntoFuture.xlsx',
         'paidPacketsDevelopment/ART-687-4-CODYesVeryLongTimeIntoFuture.xlsx',
         'paidPacketsDevelopment/ART-687-5-PSDYesMiddleOfActualPeriod.xlsx',
         'paidPacketsDevelopment/ART-687-6-PSDYesFirstQuarter.xlsx',
         'paidPacketsDevelopment/ART-687-7-PSDYesFirstQuarterUpdateEqualsReported.xlsx',
         'paidPacketsDevelopment/ART-687-8-PSDNoAfterUpdateDate2ndPeriod.xlsx',
         'paidPacketsDevelopment/ART-687-9-CODNoAfterUpdateDate2ndPeriod.xlsx',
         'paidPacketsDevelopment/ART-687-10-CODYesPeriod1_TwoUpdates.xlsx',
         'paidPacketsDevelopment/ART-687-11-CODNoPeriod1_Period3.xlsx',
         'paidPacketsDevelopment/ART-687-12-PSDNoPeriod1.xlsx',
        ]
    }
...
//            SP - Why?
            ...
            GrossClaimRoot claimRoot = new GrossClaimRoot(new ClaimRoot(ultimate, ClaimType.AGGREGATED, periodStartDate, occurrenceDate, "0"), adjustedPattern, baseDate)
//            claims.addAll(claimRoot.getClaimCashflowPackets(periodCounter))
            ...
            for (ClaimCashflowPacket claim : claims) {
                ...
                if (claim.getPaidIncrementalIndexed() > 0) {
                    ...
                    assert "payoutdates $index", payments[index]['paymentDate'].equals(claim.getUpdateDate().toLocalDate())
                }
                index++
            }
